...
//        
        ...
        JLabel l2 = new JLabel("ADD DOCTOR'S DETAILS");
...
//        
    ...
    {   
        ...
        conn c = new conn();
        String str = "insert into doctor values(null, '"+name+"','"+age+"','"+gender+"','"+specification+"','"+salary+"','"+phone+"','"+aadhar+"','"+email+"')";
    ...
    {
        new adddoc().setVisible(true);   //object of the class
    }
}
