...
public class searchdoc extends JFrame implements ActionListener{
...
//        
        ...
        JLabel l2 = new JLabel("Search Doctor");
...
//        
    ...
    {   
        ...
        else if(ae.getSource() == b3)
        {
          ...
          {
              conn p = new conn();
              String sql = "select * from doctor where aadhar = ?";
...
//    }
    ...
    {
        new searchdoc().setVisible(true);   //object of the class
    }
}
