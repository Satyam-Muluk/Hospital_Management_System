...
public class searchvac extends JFrame implements ActionListener {
    ...
    searchvac()
    {
        ...
        JLabel l2 = new JLabel("SEARCH RECORD");
...
//        JLabel dat = new JLabel("Date of first dose");
//        dat.setFont(new Font("Tahoma",Font.PLAIN,17));
//        dat .setBounds(60,380,120,30);
//        add(dat);
//        
//        t7 = new JTextField();
//        t7.setBounds(230,380,150,30);
...
//           
    ...
    {
        new searchvac().setVisible(true);   //object of the class
    }
}
